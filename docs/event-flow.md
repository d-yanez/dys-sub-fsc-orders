...
10. Persiste `orders` y `order_items` en MongoDB.
11. Responde `200` con resultado (`SUCCESS` o `PARTIAL_SUCCESS`).
12. Si falla una dependencia critica (FSC order/items o Mongo), responde `500`.
